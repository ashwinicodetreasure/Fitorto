...
public class AnimationUtil {
    ...
    public static final int ANIMATION_DURATION_MEDIUM = 1200;
    ...
    public static void crossFadeViews(View showView, View hideView) {
        crossFadeViews(showView, hideView, ANIMATION_DURATION_MEDIUM);
    }
    ...
    public static void fadeOutView(View view) {
        fadeOutView(view, ANIMATION_DURATION_MEDIUM);
    }
