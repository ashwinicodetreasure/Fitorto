...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (onItemClickListener != null) {
                onItemClickListener.onItemClick(v, (Follower) v.getTag());
            }
        }
    }
     ...
     */
    public FollowerAdapter(Activity context, ArrayList<Follower> dataSet) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        final Follower follower = mDataSet.get(position);
    ...
    public void unfollow(final Follower follower, final String flag, final ViewHolder viewHolder, final int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Follower position);
    }
}
